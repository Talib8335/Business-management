...
function upload_pic()
{
	...
	freader.onloadend = function(event)
	{
		...
		var up = document.getElementById("upload-icon");
		up.remove();
	...
	else{alert('please upload mixmimum 1mb');}	
}
function profile_name()
{
	var result = document.getElementById("welcome");
	var user_mail = sessionStorage.getItem('user_mail');
	var user_detilas = localStorage.getItem(user_mail);
	var user_data = JSON.parse(user_detilas);
